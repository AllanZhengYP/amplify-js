 ...
 *
 * @param {StorageDownloadDataRequest<S3DownloadDataOptions>} downloadDataRequest The parameters that are passed to the
...
export const downloadData = (
	downloadDataRequest: StorageDownloadDataRequest<S3DownloadDataOptions>
	...
	(
		{
			...
			key,
		}: StorageDownloadDataRequest<S3DownloadDataOptions>,
