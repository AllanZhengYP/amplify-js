 ...
 *
 * @param {StorageUploadDataRequest<S3UploadDataOptions>} uploadDataRequest The parameters that are passed to the
...
export const uploadData = (
	uploadDataRequest: StorageUploadDataRequest<S3UploadDataOptions>
